...
<form action="" class="ngl-popup-settings" data-block="<?php echo esc_attr( $this->id ); ?>">
	...
	<div class="ngl-popup-field">
		<label for="show_author">
			<input type="checkbox" id="show_author" name="show_author" value="yes" <?php if ( isset( $defaults['show_author'] ) && $defaults['show_author'] ) echo 'checked'; ?> >
	...
	<div class="ngl-popup-field">
		<label for="show_date">
			<input type="checkbox" id="show_date" name="show_date" value="yes" <?php if ( isset( $defaults['show_date'] ) && $defaults['show_date'] ) echo 'checked'; ?> >
			<span class="ngl-block-use-switch"></span>
	...
	<div class="ngl-popup-field">
		<label for="show_location">
			<input type="checkbox" id="show_location" name="show_location" value="yes" <?php if ( isset( $defaults['show_location'] ) && $defaults['show_location'] ) echo 'checked'; ?> >
			<span class="ngl-block-use-switch"></span>
	...
	<div class="ngl-popup-field">
		<label for="show_readonline">
			<input type="checkbox" id="show_readonline" name="show_readonline" value="yes" <?php if ( isset( $defaults['show_readonline'] ) && $defaults['show_readonline'] ) echo 'checked'; ?> >
			<span class="ngl-block-use-switch"></span>
	...
	<div class="ngl-popup-field">
		<label for="text_color">
			...
			<input type="text" id="text_color" name="text_color" value="<?php echo isset( $defaults['text_color'] ) ? esc_attr( $defaults['text_color'] ) : '#666666'; ?>" placeholder="#666666">
		</label>
	</div>
	...
	<div class="ngl-popup-field">
		<label for="date_format">
			...
			<input type="text" id="date_format" name="date_format" value="<?php echo isset( $defaults['date_format'] ) ? esc_attr( $defaults['date_format'] ) : 'l, j M Y'; ?>" placeholder="l, j M Y">
