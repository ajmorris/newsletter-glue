...
<form action="" class="ngl-popup-settings" data-block="<?php echo esc_attr( $this->id ); ?>">
	...
	<div class="ngl-popup-field">
		<label for="icon_size-<?php echo esc_attr( $this->id ); ?>">
			<span class="ngl-block-use-label"><?php _e( 'Icon size (pixels)', 'newsletter-glue' ); ?></span>
			<input type="number" id="icon_size-<?php echo esc_attr( $this->id ); ?>" name="icon_size" value="<?php echo isset( $defaults['icon_size'] ) ? esc_attr( $defaults['icon_size'] ) : 18; ?>" min="12" max="48" step="1">
		</label>
	</div>

	<div class="ngl-popup-field">
		<label for="icon_color-<?php echo esc_attr( $this->id ); ?>">
			<span class="ngl-block-use-label"><?php _e( 'Icon color', 'newsletter-glue' ); ?></span>
			<select id="icon_color-<?php echo esc_attr( $this->id ); ?>" name="icon_color">
	...
	<div class="ngl-popup-field">
		<label for="icon_shape-<?php echo esc_attr( $this->id ); ?>">
			<span class="ngl-block-use-label"><?php _e( 'Icon shape', 'newsletter-glue' ); ?></span>
			<select id="icon_shape-<?php echo esc_attr( $this->id ); ?>" name="icon_shape">
	...
	<div class="ngl-popup-field">
		<label for="add_description-<?php echo esc_attr( $this->id ); ?>">
			<input type="checkbox" id="add_description-<?php echo esc_attr( $this->id ); ?>" name="add_description" value="yes" <?php if ( isset( $defaults['add_description'] ) && $defaults['add_description'] ) echo 'checked'; ?> >
